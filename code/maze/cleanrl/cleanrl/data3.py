...
class Args:
    ...
    model_path_disc: str = "runs/checkpoints/diayn/<your_dqn2_run>/latest.pth"
    """from dqn2.py"""
    model_path_qnet: str = "runs/checkpoints/qtargetmaml/<your_q_online_run>/latest.pth"
    """from q_online.py"""
...
if __name__ == "__main__":
    ...
    # skill indices picked in step 2, keep this in sync with q_online.py and sf_maml.py
