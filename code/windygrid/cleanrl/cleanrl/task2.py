...
class Args:
    ...
    env_data_path: str = "runs/data/<your_dqn_run>/task_regression_data.pkl"
    ...
    workers: int = 4
    dropout: float = 0.15
    model_path2: str = "runs/checkpoints/maml/<your_sf_maml_run>/latest.pth"
    """from sf_maml.py"""
...
def load_task_data(path):
    ...
    return (
        ...
        torch.tensor(np.array(terminated, dtype=bool), dtype=torch.bool)  # <-- fix here
    )
