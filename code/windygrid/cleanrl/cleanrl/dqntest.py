...
class Args:
    ...
    w_path: str  = "runs/checkpoints/env_phi_task/<your_task2_run>/latest.pth"
    model_path: str = "runs/checkpoints/maml/<your_sf_maml_run>/latest.pth"
    """from sf_maml.py"""
    w_random: bool = False
...
if __name__ == "__main__":
    ...
    run_name = f"{args.env_id}__{args.seed}__wrandom-{args.w_random}__pretrained-{args.pretrained}__{args.maze_dim}__{time.strftime('%Y-%m-%d_%H-%M-%S')}"
    ...
    for global_step in range(args.total_timesteps):
        ...
        if terminations or truncations:
            writer.add_scalar("charts/episodic_return_modified", total_return, global_step)
            print("global step: ", global_step," total return: ", total_return, "episode length: ",global_step-ep_start)
