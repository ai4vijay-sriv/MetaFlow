...
class Args:
    ...
    # note: this model_path is not related to this pipeline (leftover from a different baseline script), leave as is
...
"""
    ...
    writer = SummaryWriter(f"runs/all_dqn_0.25/{run_name}")
    writer.add_text(
        "hyperparameters",
