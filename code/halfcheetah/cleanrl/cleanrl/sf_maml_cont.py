...
class Args:
    ...
    data_path: str = "runs/data/<your_data3_cont_run>/task_regression_data.pkl"
    """from data3_cont.py"""
    disc_path: str = "runs/checkpoints/qtargetmaml/<your_q_online_cont_run>/latest.pth"
    ...
    n_actions: int = 6  # HalfCheetah-v4 action dim
    hidden_dim: int = 120
    inner_lr: float = 1e-3
...
def train():
    ...
    # number of inner loop updates
    # skill indices picked in step 2, keep this in sync with q_online_cont.py and data3_cont.py
