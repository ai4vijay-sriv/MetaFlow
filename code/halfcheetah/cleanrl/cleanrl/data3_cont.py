...
from cleanrl.diayn.models_cont import Discriminatorbig, Critic, Actor, Discriminator
...
class Args:
    ...
    # both point at the single bundled checkpoint saved by q_online_cont.py (step 3)
    model_path_disc: str = "runs/checkpoints/qtargetmaml/<your_q_online_cont_run>/latest.pth"
    model_path_qnet: str = "runs/checkpoints/qtargetmaml/<your_q_online_cont_run>/latest.pth"
...
if __name__ == "__main__":
    ...
    # skill indices picked in step 2, keep this in sync with q_online_cont.py and sf_maml_cont.py
