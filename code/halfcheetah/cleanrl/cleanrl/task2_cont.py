...
from cleanrl.diayn.models_cont import FeatureNetwork, SFNetwork, QNetwork, Actor, Critic, SFNetworkbig
...
class Args:
    ...
    env_data_path: str = "runs/data/<your_ddpg_continuous_action_run>/task_regression_data.pkl"
    """from ddpg_continuous_action.py, with the data dump lines uncommented"""
    ...
    workers: int = 4
    dropout: float = 0.15
    model_path2: str = "runs/checkpoints/maml/<your_sf_maml_cont_run>/latest.pth"
    """from sf_maml_cont.py"""
    qnet_path: str =  "runs/checkpoints/qtargetmaml/<your_q_online_cont_run>/latest.pth"
